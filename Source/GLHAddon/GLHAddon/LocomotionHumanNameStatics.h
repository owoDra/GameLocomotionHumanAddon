...
#include "LocomotionHumanNameStatics.generated.h"


/**
 * Class that stores constants for any name related to the human character
 */
UCLASS(Meta = (BlueprintThreadSafe))
class GLHADDON_API ULocomotionHumanNameStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Human|Bones", Meta = (ReturnDisplayName = "Bone Name"))
	...
	UFUNCTION(BlueprintPure, Category = "Human|Animation Slots", Meta = (ReturnDisplayName = "Slot Name"))
	...
	UFUNCTION(BlueprintPure, Category = "Human|Animation Curves", Meta = (ReturnDisplayName = "Curve Name"))
